...
class FetchAPI {
  ...
  static Future<bool> makeConnection() async {
    ...
    if (tokenFcm != "" && email.isNotEmpty && token != "") {
      ...
      final response = await http.post(
        Uri.parse("https://13.232.213.53:8189/api/v1/notifications/connection"),
        headers: <String, String>{
          HttpHeaders.contentTypeHeader: 'application/json',
  ...
  static Future<void> getCountUnreadNotification() async {
    ...
    if (userId != 0 && token != "") {
      final response = await http.get(
        Uri.parse(
            "https://13.232.213.53:8189/api/v1/notifications/users/$userId"),
        headers: <String, String>{
          HttpHeaders.contentTypeHeader: 'application/json',
          HttpHeaders.authorizationHeader: 'Bearer $token',
        },
  ...
  static Future<ContentDoctor> fetchContentDoctorWithCondition(
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
        Uri.parse("https://13.232.213.53:8189/api/v1/doctors?" +
            condition +
  ...
  static Future<SurveyResult> submitSurvey(Answer answer) async {
    final response = await http.post(
    ...
    if (response.statusCode == 201 || response.statusCode == 200) {
      var contentJSon = json.decode(utf8.decode(response.bodyBytes));
      SurveyResult contentNews = SurveyResult.fromJson(contentJSon);
      return contentNews;
    } else {
      throw Exception("Internal server error");
    }
  ...
  static Future<List<Doctor>> fetchContentAllDoctor() async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
        Uri.parse(
            "https://13.232.213.53:8189/api/v1/doctors?is-verify=1&limit=50&page-offset=1"),
        headers: <String, String>{
          HttpHeaders.contentTypeHeader: 'application/json',
          HttpHeaders.authorizationHeader: 'Bearer $token',
        },
  ...
  static Future<List<Doctor>> fetchContentTopDoctor() async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
        Uri.parse(
            "https://13.232.213.53:8189/api/v1/doctors?order-by=Rating&order-type=desc&is-verify=1&limit=3&page-offset=1"),
        headers: <String, String>{
          HttpHeaders.contentTypeHeader: 'application/json',
          HttpHeaders.authorizationHeader: 'Bearer $token',
        },
  ...
  static Future<HealthCheck> fetchNearestHealthCheck(int patientID) async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
        Uri.parse(
            "https://13.232.213.53:8189/api/v1/health-checks?mode-search=NEAREST&type-role=USER&patient-id=" +
                patientID.toString() +
  ...
  static Future<List<TimeFrame>> fetchContentTimeFrame() async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/time-frames?startTime=00%3A00%3A00&endTime=00%3A00%3A00&page-offset=1&limit=20"),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
          });
  ...
  static Future<List<Symptom>> fetchContentSymptom() async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/symptoms?limit=20&page-offset=1"),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
          });
  ...
  static Future<List<Major>> fetchContentMajor() async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/majors?page-offset=1&limit=100"),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
          });
  ...
  static Future<List<Hospital>> fetchContentHospital() async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/hospitals?page-offset=1&limit=20"),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
          });
  ...
  static Future<List<Slot>> fetchContentSlot(int doctorID) async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/slots?start-assigned-date=" +
                  assignedDate +
                  "&doctor-id=" +
                  doctorID.toString() +
  ...
  static Future<String> createNewHealthCheck(
    ...
    if (token.isEmpty) {
      ...
      final response = await http.post(
          Uri.parse("https://13.232.213.53:8189/api/v1/health-checks"),
  ...
  static Future<int> updateMyAccountInfo(
    ...
    try {
      ...
      if (token.isEmpty) {
        ...
        Response response =
            await Dio().put("https://13.232.213.53:8189/api/v1/accounts",
                data: formData,
                options: Options(headers: <String, String>{
                  HttpHeaders.contentTypeHeader: 'multipart/form-data',
                  HttpHeaders.authorizationHeader: 'Bearer $token',
  ...
  static Future<JoinCallResponse> joinCall(int healthCheckID) async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.post(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/health-checks/join-call"),
          body: jsonEncode(data),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
  ...
  static Future<String> editHealthCheck(HealthCheck healthCheck) async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.put(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/health-checks?mode=USERS"),
  ...
  static Future<List<NotificationPatient>> fetchContentNotification(
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse(
              "https://13.232.213.53:8189/api/v1/notifications?user-id=${accountController.account.value.id}" +
  ...
  static Future<int> unReadNotification(int userID) async {
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
          Uri.parse("https://13.232.213.53:8189/api/v1/notifications/users/33"),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
          });
  ...
  static Future<String> readNotification(
    ...
    if (token.isEmpty) {
      ...
      final response = await http.put(
          Uri.parse("https://13.232.213.53:8189/api/v1/notifications"),
  ...
  static Future<bool> userLogout() async {
    ...
    if (token.isEmpty) {
      ...
      if (tokenFcm != "" && email.isNotEmpty && token != "") {
        ...
        data['email'] = email.toLowerCase();
        final response = await http.post(
          Uri.parse("https://13.232.213.53:8189/api/v1/logout"),
          headers: <String, String>{
            HttpHeaders.contentTypeHeader: 'application/json',
            HttpHeaders.authorizationHeader: 'Bearer $token',
          },
  ...
  static Future<ContentHospital> getListNearHospital(
    ...
    if (token.isEmpty) {
      ...
      final response = await http.get(
        Uri.parse(
            "https://13.232.213.53:8189/api/v1/hospitals?latitude=$lat&longitude=$lng&limit=3&page-offset=1"),
        headers: <String, String>{
          HttpHeaders.contentTypeHeader: 'application/json',
          HttpHeaders.authorizationHeader: 'Bearer $token',
        },
